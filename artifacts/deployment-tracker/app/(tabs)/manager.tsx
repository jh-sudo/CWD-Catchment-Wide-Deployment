...
export default function ManagerScreen() {
  ...
  const API_BASE_CRMS = process.env.EXPO_PUBLIC_API_URL ?? "https://cwd.pub-soarhco.stg.paas.sandbox.gov.sg";
  ...
  useEffect(() => {
    const base = process.env.EXPO_PUBLIC_API_URL ?? "https://cwd.pub-soarhco.stg.paas.sandbox.gov.sg";
    const load = () =>
      fetch(`${base}/api/tide`)
        .then((r) => r.json())
        .then((t) => setTideData({
        ...
        <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : "height"}>
          <ScrollView contentContainerStyle={s.scrollContent} keyboardShouldPersistTaps="handled">
            ...
            <Text style={[s.hintText, { color: colors.mutedForeground, marginBottom: 10 }]}>
              ...
              <Text style={{ fontFamily: "Inter_600SemiBold" }}>BU1 GBL378Z: Suffi & Nash (DAY)</Text>
            </Text>
            <TextInput
              ...
              placeholder={"BU1 GBL378Z: Suffi & Nash (DAY)\nWK3 SFB991Y: Norhisam (ND)\nCP2 : Faizal & Farhan (PD)"}
              placeholderTextColor={colors.mutedForeground}
              multiline
