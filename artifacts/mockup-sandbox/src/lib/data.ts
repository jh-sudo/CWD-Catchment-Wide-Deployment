...
export const WAREHOUSES: Warehouse[] = [
  { id: "wh-defu",    name: "Defu",         location: "Defu Industrial Park",       contactPerson: "Officer-02",  contactNumber: "+6592334346", notes: "Main distribution hub. Loading bay on east side.", active: true },
  { id: "wh-jd",      name: "Jalan Dusun",  location: "Jalan Dusun, Bishan",        contactPerson: "Officer-08", contactNumber: "+6587255366", notes: "Climate-controlled section for sensitive items.", active: true },
  { id: "wh-kw",      name: "Kallang Way",  location: "Kallang Way Industrial Area",contactPerson: "Officer-01", contactNumber: "+6596525539", notes: "24-hour access. Security guard on duty.", active: true },
  { id: "wh-sk",      name: "Sungei Kadut", location: "Sungei Kadut Industrial Area",contactPerson: "Officer-37", contactNumber: "+6592334296", notes: "Largest capacity. Forklift available.", active: true },
];
...
export const USERS: User[] = [
  { id: "usr-adli",   name: "Muhammad Officer-02 Hassan", email: "muhammad_adli_hassan@pub.gov.sg", password: "inventory888", role: "system_admin", active: true,  status: "active", createdAt: "2025-01-01T00:00:00Z" },
